...
-- ConteudoPublico
INSERT INTO ConteudoPublico (chave, valor, dataAtualizacao, codigoUtilizador) VALUES
('titulo_principal',  'Gestão Tecnológica Hospitalar Integrada',                                                                                                                                                                                           CURDATE(), 1),
('subtitulo',         'A plataforma definitiva para Engenharia Clínica e controlo absoluto de ativos médicos.',                                                                                                                                             CURDATE(), 1),
('botao_acao',        'Solicitar Demonstração',                                                                                                                                                                                                            CURDATE(), 1),
('imagem_destaque',   '/sibdas/1241028/medcore/assets/img/foto front office.jpg',                                                                                                                                                                          CURDATE(), 1),
('sobre_titulo1',     'Ecossistema Unificado',                                                                                                                                                                                                             CURDATE(), 1),
('sobre_conteudo1',   'O MedCore Inventory centraliza a gestão de equipamentos médicos. Substituímos folhas de Excel dispersas e pastas físicas por uma plataforma única e digital, garantindo dados atualizados em tempo real.',                           CURDATE(), 1),
('sobre_titulo2',     'Ciclo de Vida Clínico',                                                                                                                                                                                                             CURDATE(), 1),
('sobre_conteudo2',   'Alinhado com as diretrizes da OMS, o sistema controla os dispositivos desde a aquisição até ao seu abate técnico, servindo de base para o planeamento, segurança e análise de risco hospitalar.',                                    CURDATE(), 1),
('sobre_titulo3',     'Rastreabilidade e Futuro',                                                                                                                                                                                                          CURDATE(), 1),
('sobre_conteudo3',   'Garanta total controlo sobre a localização de ativos, fornecedores e contratos. Tudo assente numa estrutura de dados robusta, pronta para evoluir para um sistema CMMS/GMAO completo.',                                             CURDATE(), 1),
('contacto_morada',   'Rua Dr. António Bernardino de Almeida\n4200-072, Porto\nPortugal',                                                                                                                                                                  CURDATE(), 1),
('contacto_horarios', '2ª a 6ª Feira: 8h — 18h\nSábados: 9h — 13h\nPiquete de Prevenção: 24h / 7 dias',                                                                                                                                                  CURDATE(), 1),
('contacto_email',    'suporte@medcore.pt',                                                                                                                                                                                                                CURDATE(), 1),
('contacto_telefone', '+351 226 811 298',                                                                                                                                                                                                                  CURDATE(), 1);
