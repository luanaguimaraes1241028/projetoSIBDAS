...
<head>
    ...
    <title>MedCore Inventory - Remover Documento</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 px-md-4 pt-5">
                <div class="card shadow-sm border border-warning text-center mx-auto p-5 my-5" style="max-width: 580px; background-color: #fff;">
                    ...
                    <p class="fs-5 text-muted">Deseja eliminar este registo de documentação?</p>
                    
                    <h3 class="fw-bold mb-4" style="color: #1e1b4b;">Manual Técnico de Operação Dräger</h3>
                    
                    <div class="bg-light rounded p-3 mb-4 border text-start small">
                        <div class="mb-2"><strong>Ficheiro Físico:</strong> <code>manual_ventilador_v1.pdf</code></div>
                        <div><strong>Ativo Vinculado:</strong> #EQ-0042 - Ventilador Volumétrico Hospitalar</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="lista.html" class="btn btn-danger px-4 py-2 fw-bold shadow-sm">
                            <i class="fa-solid fa-trash-can me-2"></i> Eliminar Ficheiro
                        </a>
                    </div>
                </div>
            </main>
