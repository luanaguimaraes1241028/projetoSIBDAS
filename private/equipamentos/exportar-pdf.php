...
$estadoCor = [
    ...
    'inativo'        => '#dc3545',
    'em calibracao'  => '#0d6efd',
    'em quarentena'  => '#6f42c1',
    'abatido'        => '#6c757d',
];
$critCor = [
    'suporte de vida' => '#dc3545',
    'alta'            => '#f97316',
    'media'           => '#f59e0b',
    'baixa'           => '#198754',
];
...
<head>
    <meta charset="UTF-8">
    <title>Relatório de Equipamentos — MedCore</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge { display: inline-block; padding: 2px 7px; border-radius: 20px; font-size: 9px; font-weight: 600; color: #fff; }
...
<div class="page-header">
    <div>
        <h1><img src="/sibdas/1241028/medcore/assets/img/logo medcore.png" alt="MedCore" style="height:36px;vertical-align:middle;margin-right:10px;">MedCore — Relatório de Inventário</h1>
        <div style="font-size:11px;opacity:.8;margin-top:4px;">Inventário Hospitalar de Equipamentos Médicos</div>
    </div>
    <div class="meta">
...
<div class="summary">
    <div class="summary-box"><div class="num"><?= $totais->total ?></div><div class="lbl">Total</div></div>
    <div class="summary-box"><div class="num" style="color:#198754;"><?= $totais->ativos ?></div><div class="lbl">Ativos</div></div>
    <div class="summary-box"><div class="num" style="color:#f59e0b;"><?= $totais->manutencao ?></div><div class="lbl">Em Manutenção</div></div>
    <div class="summary-box"><div class="num" style="color:#dc3545;"><?= $totais->inativos ?></div><div class="lbl">Inativos</div></div>
</div>
<div class="table-wrap">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><strong><?= htmlspecialchars($eq->codigoInterno) ?></strong></td>
