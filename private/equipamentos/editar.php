...
<head>
    ...
    <title>MedCore Inventory - Atualizar Equipamento</title>
                ...
                <div class="card shadow-sm border p-4 mx-auto my-4" style="max-width: 850px; background-color: #fff;">
                    ...
                    <form action="lista.html" method="post" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" value="#EQ-0042" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Designação do Equipamento</label>
                            <input type="text" class="form-control" value="Ventilador Volumétrico Hospitalar" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Categoria / Grupo</label>
                            <select class="form-select" required>
                                <option>Bloco Operatório</option>
                                <option selected>Cuidados Intensivos (UCIP)</option>
                                <option>Radiologia / Imagiologia</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Marca</label>
                            <input type="text" class="form-control" value="Dräger" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Modelo</label>
                            <input type="text" class="form-control" value="Evita V500" required>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold">Número de Série</label>
                            <input type="text" class="form-control" value="SN-DRG-88321-X" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Fabricante</label>
                            <input type="text" class="form-control" value="Dräger Medical GmbH" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Ano de Fabrico</label>
                            <input type="number" class="form-control" value="2025" min="1900" max="2099" required>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold">Data de Aquisição</label>
                            <input type="date" class="form-control" value="2026-01-10" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Custo de Aquisição (€)</label>
                            <input type="number" step="0.01" class="form-control" value="24500.00" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" required>
                                ...
                                <option value="elevada" selected>Elevada (Risco de Vida)</option>
                            </select>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label fw-bold">Observações Gerais</label>
                            <textarea class="form-control" rows="2">Equipamento calibrado à entrada no parque tecnológico. Unidade principal destinada exclusivamente ao Bloco de Cuidados Intensivos Pediátricos.</textarea>
                        </div>
                        ...
                        <div class="row g-3 p-3 bg-light rounded border mx-0">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" value="2028-05-15" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">Contrato de Manutenção?</label>
                                <select class="form-select" required>
                                    <option value="nao">Não, apenas garantia base</option>
                                    <option value="sim" selected>Sim, contrato ativo</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">Tipo de Contrato</label>
                                <select class="form-select">
                                    <option selected>Manutenção Preventiva e Corretiva (Full Risk)</option>
                                    <option>Apenas Manutenção Preventiva</option>
                                    <option>Suporte Técnico Remoto / Calibração</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select class="form-select">
                                    ...
                                    <option>Empresa de Assistência Técnica Externa</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="2">Inclui todas as peças de desgaste rápido, calibrações de sensores de O2 e atualizações de firmware oficiais sem custos adicionais.</textarea>
                            </div>
                        </div>

                        <div class="col-12 d-flex gap-2 mt-4">
                            <a href="lista.html" class="btn btn-secondary px-4"><i class="fa-solid fa-xmark"></i> Cancelar</a>
