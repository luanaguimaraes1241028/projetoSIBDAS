...
<head>
    ...
    <title>MedCore Inventory - Localização de Equipamentos</title>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group shadow-sm">
                                            <a href="detalhes.html" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center" title="Consultar Alocação">
                                                <i class="fa-solid fa-eye text-primary"></i>
                                            </a>
                                            <a href="editar.html" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center" title="Mover Equipamento">
                                                <i class="fa-solid fa-pen-to-square text-secondary"></i>
                                            </a>
                                            <a href="apagar.html" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center" title="Desassociar">
