...
<head>
    <meta charset="UTF-8">
    <title>Relatório de Fornecedores — MedCore</title>
    <style>
...
<div class="page-header">
    <div>
        <h1><img src="/sibdas/1241028/medcore/assets/img/logo medcore.png" alt="MedCore" style="height:36px;vertical-align:middle;margin-right:10px;">MedCore — Relatório de Fornecedores</h1>
        <div style="font-size:11px;opacity:.8;margin-top:4px;">Entidades fornecedoras e parceiros técnicos</div>
    </div>
    <div class="meta">
...
<div class="summary">
    <div class="summary-box"><div class="num"><?= $total ?></div><div class="lbl">Fornecedores Ativos</div></div>
</div>
<div class="table-wrap">
    <div class="section-title">Lista de Fornecedores</div>
    <table>
        <thead>
            <tr>
                <th>Nome / NIF</th>
